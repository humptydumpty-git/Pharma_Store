...
class PharmaStore {
    ...
    getDefaultOverTheCounterDrugs() {
        ...
        const defaults = [
            ...
            // Additional OTC / common pharmacy items
            makeDrug(101, 'Elastic Crepe Bandage 10cm', 'Dressing', 0, 0, ''),
            makeDrug(102, 'Hydrogen Peroxide 3% Solution', 'Topical', 0, 0, ''),
            makeDrug(103, 'Povidone Iodine Solution', 'Topical', 0, 0, ''),
            makeDrug(104, 'Sterile Alcohol Swabs', 'Dressing', 0, 0, ''),
            makeDrug(105, 'Digital Thermometer', 'Device', 0, 0, ''),
            makeDrug(106, 'Blood Pressure Monitor', 'Device', 0, 0, ''),
            makeDrug(107, 'Blood Glucose Test Strips', 'Device', 0, 0, ''),
            makeDrug(108, 'Lancets (Blood Glucose)', 'Device', 0, 0, ''),
            makeDrug(109, 'Insulin Syringes', 'Device', 0, 0, ''),
            makeDrug(110, 'Surgical Spirit', 'Topical', 0, 0, ''),

            makeDrug(111, 'Oral Rehydration Solution Ready-to-Drink', 'Antidiarrheal', 0, 0, ''),
            makeDrug(112, 'Magnesium Hydroxide Suspension', 'Gastrointestinal', 0, 0, ''),
            makeDrug(113, 'Glycerin Suppositories (Adult)', 'Gastrointestinal', 0, 0, ''),
            makeDrug(114, 'Glycerin Suppositories (Child)', 'Gastrointestinal', 0, 0, ''),
            makeDrug(115, 'Senna Tablets', 'Laxative', 0, 0, ''),
            makeDrug(116, 'Bisacodyl Tablets', 'Laxative', 0, 0, ''),
            makeDrug(117, 'Antacid Tablets (Chewable)', 'Gastrointestinal', 0, 0, ''),
            makeDrug(118, 'Simethicone Chewable Tablets', 'Gastrointestinal', 0, 0, ''),
            makeDrug(119, 'Probiotic Sachets', 'Gastrointestinal', 0, 0, ''),
            makeDrug(120, 'Activated Charcoal Capsules', 'Antidiarrheal', 0, 0, ''),

            makeDrug(121, 'Vitamin E Capsules', 'Supplement', 0, 0, ''),
            makeDrug(122, 'Omega-3 Fish Oil Capsules', 'Supplement', 0, 0, ''),
            makeDrug(123, 'Joint Support Glucosamine Capsules', 'Supplement', 0, 0, ''),
            makeDrug(124, 'Hair, Skin & Nails Multivitamin', 'Supplement', 0, 0, ''),
            makeDrug(125, 'Children Chewable Multivitamins', 'Supplement', 0, 0, ''),
            makeDrug(126, 'Vitamin A Capsules', 'Supplement', 0, 0, ''),
            makeDrug(127, 'Folic Acid 400mcg Tablets', 'Supplement', 0, 0, ''),
            makeDrug(128, 'Vitamin B12 1000mcg Tablets', 'Supplement', 0, 0, ''),
            makeDrug(129, 'Vitamin K Tablets', 'Supplement', 0, 0, ''),
            makeDrug(130, 'Zinc + Vitamin C Lozenges', 'Supplement', 0, 0, ''),

            makeDrug(131, 'Chlorhexidine Mouthwash', 'Dental', 0, 0, ''),
            makeDrug(132, 'Fluoride Toothpaste', 'Dental', 0, 0, ''),
            makeDrug(133, 'Orthodontic Wax', 'Dental', 0, 0, ''),
            makeDrug(134, 'Dental Floss', 'Dental', 0, 0, ''),
            makeDrug(135, 'Children Toothpaste (Fluoride)', 'Dental', 0, 0, ''),
            makeDrug(136, 'Mouth Spray (Breath Freshener)', 'Dental', 0, 0, ''),
            makeDrug(137, 'Sensitive Teeth Toothpaste', 'Dental', 0, 0, ''),
            makeDrug(138, 'Gingivitis Treatment Gel', 'Dental', 0, 0, ''),
            makeDrug(139, 'Teething Gel (Infant)', 'Paediatric', 0, 0, ''),
            makeDrug(140, 'Tongue Depressors (Wooden)', 'Dressing', 0, 0, ''),

            makeDrug(141, 'Allergy Relief Nasal Spray', 'Antihistamine', 0, 0, ''),
            makeDrug(142, 'Decongestant Nasal Drops (Adult)', 'Cough & Cold', 0, 0, ''),
            makeDrug(143, 'Decongestant Nasal Drops (Child)', 'Cough & Cold', 0, 0, ''),
            makeDrug(144, 'Steam Inhalation Capsules', 'Respiratory', 0, 0, ''),
            makeDrug(145, 'Throat Spray Antiseptic', 'Cough & Cold', 0, 0, ''),
            makeDrug(146, 'Vitamin C Effervescent Tablets', 'Supplement', 0, 0, ''),
            makeDrug(147, 'Immune Support Herbal Tonic', 'Supplement', 0, 0, ''),
            makeDrug(148, 'Herbal Cough Syrup', 'Cough & Cold', 0, 0, ''),
            makeDrug(149, 'Herbal Malaria Tonic', 'Antimalarial', 0, 0, ''),
            makeDrug(150, 'Herbal Blood Tonic', 'Supplement', 0, 0, ''),

            makeDrug(151, 'Pregnancy Test Strips', 'Diagnostic', 0, 0, ''),
            makeDrug(152, 'Ovulation Test Strips', 'Diagnostic', 0, 0, ''),
            makeDrug(153, 'Urinalysis Test Strips (10 Parameter)', 'Diagnostic', 0, 0, ''),
            makeDrug(154, 'HIV Rapid Test Kit (Professional Use)', 'Diagnostic', 0, 0, ''),
            makeDrug(155, 'Malaria Rapid Test Kits', 'Diagnostic', 0, 0, ''),
            makeDrug(156, 'Alcohol Breath Test Strips', 'Diagnostic', 0, 0, ''),
            makeDrug(157, 'Digital Weighing Scale', 'Device', 0, 0, ''),
            makeDrug(158, 'Peak Flow Meter', 'Respiratory', 0, 0, ''),
            makeDrug(159, 'Pulse Oximeter', 'Device', 0, 0, ''),
            makeDrug(160, 'Reusable Hot & Cold Pack', 'Device', 0, 0, ''),

            makeDrug(161, 'Hand Sanitizer 500ml', 'Topical', 0, 0, ''),
            makeDrug(162, 'Hand Sanitizer 100ml', 'Topical', 0, 0, ''),
            makeDrug(163, 'Disposable Face Masks (Box)', 'PPE', 0, 0, ''),
            makeDrug(164, 'Reusable Cloth Mask', 'PPE', 0, 0, ''),
            makeDrug(165, 'Nitrile Examination Gloves (Box)', 'PPE', 0, 0, ''),
            makeDrug(166, 'Surgical Gloves Sterile Pair', 'PPE', 0, 0, ''),
            makeDrug(167, 'Surgical Face Mask (3-ply)', 'PPE', 0, 0, ''),
            makeDrug(168, 'Disposable Aprons', 'PPE', 0, 0, ''),
            makeDrug(169, 'Protective Goggles', 'PPE', 0, 0, ''),
            makeDrug(170, 'Face Shield', 'PPE', 0, 0, ''),

            makeDrug(171, 'Antacid + Simethicone Suspension', 'Gastrointestinal', 0, 0, ''),
            makeDrug(172, 'Herbal Laxative Syrup', 'Laxative', 0, 0, ''),
            makeDrug(173, 'Apple Cider Vinegar Capsules', 'Supplement', 0, 0, ''),
            makeDrug(174, 'Garlic Oil Capsules', 'Supplement', 0, 0, ''),
            makeDrug(175, 'Ginkgo Biloba Capsules', 'Supplement', 0, 0, ''),
            makeDrug(176, 'Herbal Sleep Aid Tablets', 'Supplement', 0, 0, ''),
            makeDrug(177, 'Electrolyte Sports Drink Powder', 'Supplement', 0, 0, ''),
            makeDrug(178, 'Energy Tonic Syrup', 'Supplement', 0, 0, ''),
            makeDrug(179, 'Weight Gain Supplement Powder', 'Supplement', 0, 0, ''),
            makeDrug(180, 'Meal Replacement Shake', 'Supplement', 0, 0, ''),

            makeDrug(181, 'Insecticide Treated Bed Net', 'Preventive', 0, 0, ''),
            makeDrug(182, 'Mosquito Coil Pack', 'Preventive', 0, 0, ''),
            makeDrug(183, 'Insect Repellent Spray', 'Preventive', 0, 0, ''),
            makeDrug(184, 'Snake Bite First Aid Kit', 'First Aid', 0, 0, ''),
            makeDrug(185, 'Travel First Aid Kit', 'First Aid', 0, 0, ''),
            makeDrug(186, 'Burn Dressing Sterile', 'Dressing', 0, 0, ''),
            makeDrug(187, 'Triangular Bandage', 'Dressing', 0, 0, ''),
            makeDrug(188, 'Finger Splint', 'Device', 0, 0, ''),
            makeDrug(189, 'Elastic Knee Support', 'Device', 0, 0, ''),
            makeDrug(190, 'Ankle Support Brace', 'Device', 0, 0, ''),

            makeDrug(191, 'Nicotine Gum 2mg', 'Smoking Cessation', 0, 0, ''),
            makeDrug(192, 'Nicotine Patches 21mg', 'Smoking Cessation', 0, 0, ''),
            makeDrug(193, 'Herbal Tea - Digestive', 'Herbal', 0, 0, ''),
            makeDrug(194, 'Herbal Tea - Sleep', 'Herbal', 0, 0, ''),
            makeDrug(195, 'Herbal Tea - Immunity', 'Herbal', 0, 0, ''),
            makeDrug(196, 'Herbal Balm (Muscle Rub)', 'Topical', 0, 0, ''),
            makeDrug(197, 'Capsaicin Cream', 'Topical', 0, 0, ''),
            makeDrug(198, 'Muscle Relaxant Gel', 'Topical', 0, 0, ''),
            makeDrug(199, 'Anti-dandruff Shampoo Medicated', 'Topical', 0, 0, ''),
            makeDrug(200, 'Antifungal Medicated Soap', 'Topical', 0, 0, '')
        ];
